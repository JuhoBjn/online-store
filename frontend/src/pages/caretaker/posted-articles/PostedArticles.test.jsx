...
describe("The posted articles page", () => {
  it("should display a header with a title", () => {
    render(<RouterProvider router={testRouter} />);

    expect(
      screen.getByTestId("posted-articles-page-header")
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("posted-articles-page-header-title")
    ).toBeInTheDocument();
  });

  it("should displya a list of posted articles", () => {
    render(<RouterProvider router={testRouter} />);

    expect(screen.getByTestId("posted-articles-container")).toBeInTheDocument();
